...
function App() {
  ...
  const [dbMonito, setDbMonito] = useState(false)
  ...
  const handleLikes = (item) => {
    ...
    let selectedMovieIndex =  movies.findIndex(val => val.id === item.id)
    newMovies[selectedMovieIndex] = {
      ...item,
      like: item.like+1,
      price: item.price+10,
    }
...
<button className='hero-watch'>
  Watch now
    ...
    <div className='movie-card-wrapper'>
      {
        movies.sort((a, b) => b.like - a.like ).map((item, i) => (
<MovieCard key={i} bg={item.img}>
    <div className='movieoverlay'>
      ...
      <div className='cat'>
        ...
        <svg width="80" height="16" viewBox="0 0 80 16" fill="none" xmlns="http://www.w3.org/2000/svg">
        <path d="M8.00001 3.61352L8.95841 6.36519L9.13371 6.8685H9.66668H12.5206L10.3106 8.62805L9.91741 8.94114L10.0575 9.42385L10.8685 12.2179L8.41985 10.5637L8.00001 10.2801L7.58017 10.5637L5.13155 12.2179L5.94251 9.42385L6.08261 8.94114L5.68939 8.62805L3.47942 6.8685H6.33334H6.86631L7.04161 6.36519L8.00001 3.61352Z" fill="white" stroke="white" stroke-width="1.5"/>
        <path d="M24 3.61352L24.9584 6.36519L25.1337 6.8685H25.6667H28.5206L26.3106 8.62805L25.9174 8.94114L26.0575 9.42385L26.8685 12.2179L24.4199 10.5637L24 10.2801L23.5802 10.5637L21.1316 12.2179L21.9425 9.42385L22.0826 8.94114L21.6894 8.62805L19.4794 6.8685H22.3333H22.8663L23.0416 6.36519L24 3.61352Z" fill="white" stroke="white" stroke-width="1.5"/>
        <path d="M40 3.61352L40.9584 6.36519L41.1337 6.8685H41.6667H44.5206L42.3106 8.62805L41.9174 8.94114L42.0575 9.42385L42.8685 12.2179L40.4199 10.5637L40 10.2801L39.5802 10.5637L37.1316 12.2179L37.9425 9.42385L38.0826 8.94114L37.6894 8.62805L35.4794 6.8685H38.3333H38.8663L39.0416 6.36519L40 3.61352Z" fill="white" stroke="white" stroke-width="1.5"/>
        <path d="M56 3.61352L56.9584 6.36519L57.1337 6.8685H57.6667H60.5206L58.3106 8.62805L57.9174 8.94114L58.0575 9.42385L58.8685 12.2179L56.4199 10.5637L56 10.2801L55.5802 10.5637L53.1316 12.2179L53.9425 9.42385L54.0826 8.94114L53.6894 8.62805L51.4794 6.8685H54.3333H54.8663L55.0416 6.36519L56 3.61352Z" fill="white" stroke="white" stroke-width="1.5"/>
        <path d="M72 3.61352L72.9584 6.36519L73.1337 6.8685H73.6667H76.5206L74.3106 8.62805L73.9174 8.94114L74.0575 9.42385L74.8685 12.2179L72.4199 10.5637L72 10.2801L71.5802 10.5637L69.1316 12.2179L69.9425 9.42385L70.0826 8.94114L69.6894 8.62805L67.4794 6.8685H70.3333H70.8663L71.0416 6.36519L72 3.61352Z" fill="white" stroke="white" stroke-width="1.5"/>
        </svg>

        <h4 className='mv-name'>{item.name}</h4>

        <div className='d-flex'>
        <span className='fantasy-price'> ₦{item.price}</span>

      


        </div>
        <button onClick={() => handleLikes(item)} className='hero-watch'>
        <AiFillHeart size={15}  color='red' /> {item.like} Likes 
        </button>
